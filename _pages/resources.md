...
_Data_
* [BASIL DB](https://basil-db.github.io/about.html) - aggregates data on bioactive compounds derived from natural sources and their associated health effects in the form of a knowledge graph.
* [IntelliGraphs](https://github.com/thiviyanT/IntelliGraphs) - a set of benchmark datasets for knowledge graph generation. Also includes scripts for synthetic generation of knowledge graphs. 
